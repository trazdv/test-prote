...
export const siteConfig = {
  ...
  googleForms: {
    ...
    // Formulario para solicitudes de voluntariado. Los campos concretos
    // (y por tanto los entry.XXXXX) se ajustarán cuando definas el
    // formulario final; de momento incluye nombre, contacto, disponibilidad
    // y un mensaje libre.
    voluntariado: {
      actionUrl: 'https://docs.google.com/forms/d/e/TU_ID_DE_FORMULARIO_VOLUNTARIADO/formResponse',
      entries: {
        nombreSolicitante: 'entry.111111111',
        email: 'entry.222222222',
        telefono: 'entry.333333333',
        disponibilidad: 'entry.444444444',
        mensaje: 'entry.555555555',
      },
    },
  },
};
